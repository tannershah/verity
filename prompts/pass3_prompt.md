# Pass 3 — Synthesis (strongest available model, max effort)
...
- Do NOT write a red-team section — that is a separate, independent pass.
- Commit with message "pass3: synthesis and eval plan".
